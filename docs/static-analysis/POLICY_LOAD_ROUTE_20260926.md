...
* firmware: `[FIRMWARE]\MRX-W09\extracted\` (`parts\vendor_a.erofs`, `parts\super_out\vendor.img`,
  `vmlinux.elf`)
...
The firmware extraction `[FIRMWARE]\MRX-W09\extracted\` has **no extracted /system or /vendor
